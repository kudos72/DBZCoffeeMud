...
public class DrowElf extends StdMOB
{
	...
	public DrowElf()
	{
		...
		baseCharStats().setStat(CharStats.STAT_SPIRIT,13 + Math.abs(randomizer.nextInt() % 6));
		baseCharStats().setStat(CharStats.STAT_DEXTERITY,15 + Math.abs(randomizer.nextInt() % 6));
		baseCharStats().setStat(CharStats.STAT_ENDURANCE,12 + Math.abs(randomizer.nextInt() % 6));
		baseCharStats().setStat(CharStats.STAT_QUICKNESS,13 + Math.abs(randomizer.nextInt() % 6));
