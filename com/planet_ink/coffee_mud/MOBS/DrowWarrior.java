...
public class DrowWarrior extends DrowElf
{
	...
	public DrowWarrior()
	{
		...
		baseCharStats().setStat(CharStats.STAT_SPIRIT,13 + CMLib.dice().roll(1,6,0));
		baseCharStats().setStat(CharStats.STAT_DEXTERITY,15 + CMLib.dice().roll(1,6,0));
		baseCharStats().setStat(CharStats.STAT_ENDURANCE,12 + CMLib.dice().roll(1,6,0));
		baseCharStats().setStat(CharStats.STAT_QUICKNESS,13 + CMLib.dice().roll(1,6,0));
