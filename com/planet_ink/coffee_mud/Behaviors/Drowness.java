...
public class Drowness extends StdBehavior
{
	...
	public void startBehavior(PhysicalAgent forMe)
	{
		...
		mob.baseCharStats().setStat(CharStats.STAT_SPIRIT,13 + CMLib.dice().roll(1,6,0));
		mob.baseCharStats().setStat(CharStats.STAT_DEXTERITY,15 + CMLib.dice().roll(1,6,0));
		mob.baseCharStats().setStat(CharStats.STAT_ENDURANCE,12 + CMLib.dice().roll(1,6,0));
		mob.baseCharStats().setStat(CharStats.STAT_QUICKNESS,13 + CMLib.dice().roll(1,6,0));
