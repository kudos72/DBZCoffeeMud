		...
		&&(!CMSecurity.isDisabled(CMSecurity.DisFlag.ALL_AGEING)))
		{
			switch(baseStats.ageCategory())
			{
				...
				case Race.AGE_TODDLER:
					...
					charStats.setStat(CharStats.STAT_MAX_SPIRIT_ADJ,charStats.getStat(CharStats.STAT_MAX_SPIRIT_ADJ)-4);
					break;
				case Race.AGE_CHILD:
					...
					charStats.setStat(CharStats.STAT_MAX_SPIRIT_ADJ,charStats.getStat(CharStats.STAT_MAX_SPIRIT_ADJ)-2);
					break;
				case Race.AGE_YOUNGADULT:
				case Race.AGE_MATURE:
					break;
				case Race.AGE_MIDDLEAGED:
					charStats.setStat(CharStats.STAT_SAVE_MIND,charStats.getStat(CharStats.STAT_SAVE_MIND)+5);
					charStats.setStat(CharStats.STAT_MAX_STRENGTH_ADJ,charStats.getStat(CharStats.STAT_MAX_STRENGTH_ADJ)-1);
					charStats.setStat(CharStats.STAT_MAX_ENDURANCE_ADJ,charStats.getStat(CharStats.STAT_MAX_ENDURANCE_ADJ)-1);
					...
					charStats.setStat(CharStats.STAT_MAX_SPIRIT_ADJ,charStats.getStat(CharStats.STAT_MAX_SPIRIT_ADJ)+1);
					charStats.setStat(CharStats.STAT_MAX_QUICKNESS_ADJ,charStats.getStat(CharStats.STAT_MAX_QUICKNESS_ADJ)+1);
					break;
				case Race.AGE_OLD:
					charStats.setStat(CharStats.STAT_SAVE_MIND,charStats.getStat(CharStats.STAT_SAVE_MIND)+10);
					charStats.setStat(CharStats.STAT_SAVE_UNDEAD,charStats.getStat(CharStats.STAT_SAVE_UNDEAD)-5);
					charStats.setStat(CharStats.STAT_MAX_STRENGTH_ADJ,charStats.getStat(CharStats.STAT_MAX_STRENGTH_ADJ)-2);
					charStats.setStat(CharStats.STAT_MAX_ENDURANCE_ADJ,charStats.getStat(CharStats.STAT_MAX_ENDURANCE_ADJ)-2);
					charStats.setStat(CharStats.STAT_MAX_DEXTERITY_ADJ,charStats.getStat(CharStats.STAT_MAX_DEXTERITY_ADJ)-2);
					charStats.setStat(CharStats.STAT_MAX_INTELLIGENCE_ADJ,charStats.getStat(CharStats.STAT_MAX_INTELLIGENCE_ADJ)+2);
					charStats.setStat(CharStats.STAT_MAX_SPIRIT_ADJ,charStats.getStat(CharStats.STAT_MAX_SPIRIT_ADJ)+2);
					charStats.setStat(CharStats.STAT_MAX_QUICKNESS_ADJ,charStats.getStat(CharStats.STAT_MAX_QUICKNESS_ADJ)+2);
					break;
				case Race.AGE_VENERABLE:
					...
					charStats.setStat(CharStats.STAT_MAX_ENDURANCE_ADJ,charStats.getStat(CharStats.STAT_MAX_ENDURANCE_ADJ)-3);
					...
					charStats.setStat(CharStats.STAT_MAX_SPIRIT_ADJ,charStats.getStat(CharStats.STAT_MAX_SPIRIT_ADJ)+3);
					charStats.setStat(CharStats.STAT_MAX_QUICKNESS_ADJ,charStats.getStat(CharStats.STAT_MAX_QUICKNESS_ADJ)+3);
					break;
				case Race.AGE_ANCIENT:
				{
					...
					charStats.setStat(CharStats.STAT_MAX_ENDURANCE_ADJ,charStats.getStat(CharStats.STAT_MAX_ENDURANCE_ADJ)-(3+(num)));
					...
					charStats.setStat(CharStats.STAT_MAX_SPIRIT_ADJ,charStats.getStat(CharStats.STAT_MAX_SPIRIT_ADJ)+(3+(num)));
					charStats.setStat(CharStats.STAT_MAX_QUICKNESS_ADJ,charStats.getStat(CharStats.STAT_MAX_QUICKNESS_ADJ)+(3+(num)));
					break;
				}
			}
		}
