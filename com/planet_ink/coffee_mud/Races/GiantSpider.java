...
{
	@Override public String ID(){	return "GiantSpider"; }
	@Override public String name(){ return "Giant Spider"; }
	@Override public int shortestMale(){return 42;}
	@Override public int shortestFemale(){return 42;}
