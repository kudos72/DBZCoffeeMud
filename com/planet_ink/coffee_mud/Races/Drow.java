...
public class Drow extends Elf
{
	...
	public void affectCharStats(MOB affectedMOB, CharStats affectableStats)
	{
		...
		affectableStats.setStat(CharStats.STAT_ENDURANCE,affectableStats.getStat(CharStats.STAT_ENDURANCE)-3);
		affectableStats.setStat(CharStats.STAT_MAX_ENDURANCE_ADJ,affectableStats.getStat(CharStats.STAT_MAX_ENDURANCE_ADJ)-3);
		affectableStats.setStat(CharStats.STAT_QUICKNESS,affectableStats.getStat(CharStats.STAT_QUICKNESS)-3);
		affectableStats.setStat(CharStats.STAT_MAX_QUICKNESS_ADJ,affectableStats.getStat(CharStats.STAT_MAX_QUICKNESS_ADJ)-3);
