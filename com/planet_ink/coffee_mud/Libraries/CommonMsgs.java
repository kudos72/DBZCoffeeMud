	...
	protected void handleBeingMobLookedAt(CMMsg msg)
	{
		...
		if(CMLib.flags().canBeSeenBy(viewedmob,viewermob))
		{
			...
			if((longlook)&&(viewermob.charStats().getStat(CharStats.STAT_INTELLIGENCE)>12))
			{
				...
				myDescription.append(relativeCharStatTest(C,viewedmob,"more sickly","healthier",CharStats.STAT_ENDURANCE));
				myDescription.append(relativeCharStatTest(C,viewedmob,"more repulsive","more attractive",CharStats.STAT_QUICKNESS));
				myDescription.append(relativeCharStatTest(C,viewedmob,"more naive","wiser",CharStats.STAT_SPIRIT));
