...
public interface CharStats extends CMCommon, Modifiable
{
	...
	public static final int STAT_ENDURANCE=3;
	/** stat constant for  constitution*/
	public static final int STAT_QUICKNESS=4;
	/** stat constant for  charisma*/
	public static final int STAT_SPIRIT=5;
	...
	public static final int STAT_MAX_ENDURANCE_ADJ =25;
	/** stat constant for  mac charisma adjustment*/
	public static final int STAT_MAX_QUICKNESS_ADJ =26;
	/** stat constant for  max wisdom adjustment*/
	public static final int STAT_MAX_SPIRIT_ADJ =27;
