...
public class Spell_Wish extends Spell
{
	...
	public void wishDrain(MOB mob, int expLoss, boolean conLoss)
	{
		...
		if(conLoss)
		{
			...
			mob.baseCharStats().setStat(CharStats.STAT_ENDURANCE,mob.baseCharStats().getStat(CharStats.STAT_ENDURANCE)-1);
			mob.baseCharStats().setStat(CharStats.STAT_MAX_ENDURANCE_ADJ,mob.baseCharStats().getStat(CharStats.STAT_MAX_ENDURANCE_ADJ)-1);
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(((!auto)&&(mob.phyStats().level()<20))||(mob.charStats().getStat(CharStats.STAT_ENDURANCE)<2))
		{
