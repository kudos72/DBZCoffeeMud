...
public class Prop_EnterAdjuster extends Property implements TriggeredAffect
{
	...
	public boolean okMessage(final Environmental myHost, final CMMsg msg)
	{
		...
		&&((mask==null)||(CMLib.masking().maskCheck(mask,msg.source(),true))))
		{
			...
			mob.baseCharStats().setStat(CharStats.STAT_QUICKNESS,mob.baseCharStats().getStat(CharStats.STAT_QUICKNESS)+CMParms.getParmPlus(parameters[0],"cha"));
			mob.baseCharStats().setStat(CharStats.STAT_ENDURANCE,mob.baseCharStats().getStat(CharStats.STAT_ENDURANCE)+CMParms.getParmPlus(parameters[0],"con"));
			...
			mob.baseCharStats().setStat(CharStats.STAT_SPIRIT,mob.baseCharStats().getStat(CharStats.STAT_SPIRIT)+CMParms.getParmPlus(parameters[0],"wis"));
