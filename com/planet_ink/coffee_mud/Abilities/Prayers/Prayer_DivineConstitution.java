...
public class Prayer_DivineConstitution extends Prayer
{
	...
	public void affectCharStats(MOB affected, CharStats affectableStats)
	{
		...
		if(affected==null)
			return;
		affectableStats.setStat(CharStats.STAT_ENDURANCE, affectableStats.getStat(CharStats.STAT_ENDURANCE)+conPts);
		affectableStats.setStat(CharStats.STAT_MAX_ENDURANCE_ADJ, affectableStats.getStat(CharStats.STAT_MAX_ENDURANCE_ADJ)+conPts);
	}
