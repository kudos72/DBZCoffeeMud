...
public class Chant_Hibernation extends Chant
{
	...
	public boolean tick(Tickable ticking, int tickID)
	{
		...
		{
			roundsHibernating++;
			final double man = ( ( mob.charStats().getStat( CharStats.STAT_INTELLIGENCE ) + mob.charStats().getStat( CharStats.STAT_SPIRIT) ) );
			...
			{
				final double hp=mob.charStats().getStat( CharStats.STAT_ENDURANCE);
