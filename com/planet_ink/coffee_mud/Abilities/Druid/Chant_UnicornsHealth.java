...
public class Chant_UnicornsHealth extends Chant
{
	...
	public void affectCharStats(MOB affected, CharStats affectableStats)
	{
		...
		affectableStats.setStat(CharStats.STAT_ENDURANCE,affectableStats.getStat(CharStats.STAT_ENDURANCE)+((affected.phyStats().level()+(2*super.getXLEVELLevel(invoker())))/6));
	}
