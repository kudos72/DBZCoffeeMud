...
public class Disease_Malaria extends Disease
{
	...
	public void affectCharStats(MOB affected, CharStats affectableStats)
	{
		...
		affectableStats.setStat(CharStats.STAT_ENDURANCE,affectableStats.getStat(CharStats.STAT_ENDURANCE)-(5+conDown));
		if((affectableStats.getStat(CharStats.STAT_ENDURANCE)<=0)&&(!norecurse))
		{
			conDown=-1;
			MOB diseaser=invoker;
			if(diseaser==null)
