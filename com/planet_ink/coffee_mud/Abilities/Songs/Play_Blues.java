...
public class Play_Blues extends Play
{
	...
	public void affectPhyStats(Physical affected, PhyStats affectableStats)
	{
		...
		affectableStats.setAttackAdjustment(affectableStats.attackAdjustment()
											-((invoker().charStats().getStat(CharStats.STAT_QUICKNESS)/4)
	...
	public void affectCharStats(MOB mob, CharStats stats)
	{
		...
		if((invoker()!=null)&&(invoker()!=mob))
			stats.setStat(CharStats.STAT_SAVE_JUSTICE,stats.getStat(CharStats.STAT_SAVE_JUSTICE)-(invoker().charStats().getStat(CharStats.STAT_QUICKNESS)+getXLEVELLevel(invoker())));
	}
}
