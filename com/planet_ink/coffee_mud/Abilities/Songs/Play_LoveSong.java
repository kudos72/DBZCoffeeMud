...
public class Play_LoveSong extends Play
{
	...
	public boolean tick(Tickable ticking, int tickID)
	{
		...
		if(affected instanceof MOB)
		{
			...
			for(int i=0;i<mob.location().numInhabitants();i++)
			{
				...
				&&(M.charStats().getSave(CharStats.STAT_QUICKNESS)>14))
	...
	public void affectCharStats(MOB affected, CharStats affectableStats)
	{
		...
		affectableStats.setStat(CharStats.STAT_QUICKNESS,affectableStats.getStat(CharStats.STAT_QUICKNESS)+4+(getXLEVELLevel(invoker())));
	}
}
