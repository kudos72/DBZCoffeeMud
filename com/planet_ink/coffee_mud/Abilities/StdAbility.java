...
public class StdAbility implements Ability
{
	...
	public void teach(MOB teacher, MOB student)
	{
		if(student.fetchAbility(ID())==null)
		{
			...
			newAbility.setProficiency((int)Math.round(CMath.mul(proficiency(),((CMath.div(teacher.charStats().getStat(CharStats.STAT_SPIRIT)+student.charStats().getStat(CharStats.STAT_INTELLIGENCE),100.0))))));
	...
	public void practice(MOB teacher, MOB student)
	{
		...
		if(yourAbility!=null)
		{
			...
			if(yourAbility.proficiency()<prof75)
			{
				...
				int newProf = yourAbility.proficiency()+(int)Math.round(25.0*(CMath.div(teacher.charStats().getStat(CharStats.STAT_SPIRIT)+student.charStats().getStat(CharStats.STAT_INTELLIGENCE),36.0)));
				if(newProf > prof75)
					newProf=prof75;
